...
%currently only Odometry and PoseStamped are supported
...
% Creating an aligner
pose_trajectory_aligner = PoseTrajectoryAligner6Dof();
% Resampling the data
[vicon_poses_resampled, odom_poses_resampled] =...
    pose_trajectory_aligner.truncateAndResampleDatastreams(vicon_poses,...
                                                               odom_poses);
% Calculating the alignment transform
orientation_scaling=1.0;
T_alignment = pose_trajectory_aligner.calculateAlignmentTransform(vicon_poses_resampled,...
